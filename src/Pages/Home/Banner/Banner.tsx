...
export const Banner = () => {
  ...
  ></video>
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-6">
        ...
        {/* --------------- Button -----------------------------*/}
        <button className="mt-4 px-6 py-2 bg-white hover:bg-purple-700 text-black font-semibold rounded-lg transition-all duration-300 shadow-lg animate-fadeIn delay-500">
          Explore Now
        </button>
      </div>
    </div>
